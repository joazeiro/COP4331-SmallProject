...
function openEditModal(i) {
    indexEditButtonContact = i;
    const row = contactTable.getElementsByTagName("tr")[indexEditButtonContact];
...
function editContact() {
    const row = contactTable.getElementsByTagName("tr")[indexEditButtonContact];
    const cells = row.getElementsByTagName("td");
    const originalFirstName = cells[0].innerHTML;
    const originalLastName = cells[1].innerHTML;
    const originalEmail = cells[2].innerHTML;
    const originalPhoneNumber = cells[3].innerHTML;
    const originalLinkedin = cells[4].innerHTML;
    ...
    editContactFormObject["originalFirstName"] = originalFirstName;
    editContactFormObject["originalLastName"] = originalLastName;
    editContactFormObject["originalEmail"] = originalEmail;
    editContactFormObject["originalPhoneNumber"] = originalPhoneNumber;
    editContactFormObject["originalLinkedin"] = originalLinkedin;
